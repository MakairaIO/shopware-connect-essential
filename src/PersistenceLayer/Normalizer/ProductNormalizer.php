...
class ProductNormalizer implements NormalizerInterface
{
    ...
    public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $data = [
            ...
            'purchasePrice'       => $object->getPurchasePrices()?->first()?->getGross(),
            'listPrice'           => $object->getCalculatedPrice()->getListPrice()?->getPrice(),
            'regulationPrice'     => $object->getCalculatedPrice()->getRegulationPrice()?->getPrice(),

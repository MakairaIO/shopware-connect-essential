...
class ProductNormalizer implements NormalizerInterface
{
    ...
    public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $data = [
            ...
            'ean'                 => array_values(array_filter([$object->getEan(), $object->getProductNumber()])),
            ...
            'price'               => $object->getCalculatedPrice()->getUnitPrice()                    ?? 0,
            'referencePrice'      => $object->getCalculatedPrice()->getReferencePrice()?->getPrice()  ?? 0,
            'purchasePrice'       => $object->getPurchasePrices()?->first()?->getGross()              ?? 0,
